...
(async () => {
  let e = {
      augiA20Il: {
        ...
        page: Su(
          () =>
            import('./rXSh3L0GCJENVfvIV-TBCvQkHORnvsYmUjrs0rD_1P0.63KKHF33.mjs'),
        ),
        path: '/',
      },
    },
    n = [{ code: 'en-US', id: 'default', name: 'English', slug: '' }],
    t = Su(() => import('./__framer-not-found-page.GKJH3WTL.mjs')),
...
(async () => {
  let { default: e } = await import('./__framer-badge.J7MZXG4X.mjs'),
    n = Wo(Qo);
  _u(() => {
...
//# sourceMappingURL=_script0.ZDKTPIJR.mjs.map
