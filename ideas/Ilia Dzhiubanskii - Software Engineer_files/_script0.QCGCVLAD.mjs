...
function cf(e, n, t, l, u) {
  switch (n) {
    ...
    case 'gotpointercapture':
      return (
        (r = u.pointerId),
        Ut.set(r, ft(Ut.get(r) || null, e, n, t, l, u)),
        !0
      );
  }
  return !1;
...
(async () => {
  let e = {
      augiA20Il: {
        ...
        page: Su(
          () =>
            import('./9tSOn8ku_UEuOBqNA9oTTrGrHztPcZJ4FKq68xhyDiI.KMTIAPOR.mjs'),
        ),
        path: '/',
      },
    },
    n = [{ code: 'en-US', id: 'default', name: 'English', slug: '' }],
    t = Su(() => import('./__framer-not-found-page.3EKUMGIJ.mjs')),
...
(async () => {
  let { default: e } = await import('./__framer-badge.4EAM24ZC.mjs'),
    n = Wo(Qo);
  _u(() => {
...
//# sourceMappingURL=_script0.QCGCVLAD.mjs.map
